 ...
 * @author alessandro
 */
public class form_riwayatusulan_p_user extends javax.swing.JFrame {
    ...
    public form_riwayatusulan_p_user(String id) {
        ...
        this.addWindowListener(new WindowAdapter() {
            public void windowClosing(WindowEvent we) {
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    setDefaultCloseOperation(form_riwayatusulan_p_user.DISPOSE_ON_CLOSE);
                } else if (confirm == JOptionPane.NO_OPTION) {
                    setDefaultCloseOperation(form_riwayatusulan_p_user.DO_NOTHING_ON_CLOSE);
                }
            }
        });
        ...
        //tampil_usulanpangkat_valid();

    }

    private form_riwayatusulan_p_user() {
    ...
    private void initComponents() {
        ...
        label_riwayat_usulanpangkat = new javax.swing.JLabel();
        ...
        label_riwayat_usulanpangkat.setFont(new java.awt.Font("Karla", 1, 36)); // NOI18N
        label_riwayat_usulanpangkat.setForeground(new java.awt.Color(72, 60, 50));
        label_riwayat_usulanpangkat.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        label_riwayat_usulanpangkat.setText("RIWAYAT USULAN PANGKAT");
        ...
        tbl_usulanpangkat.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbl_usulanpangkatMouseClicked(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addComponent(label_riwayat_usulanpangkat, javax.swing.GroupLayout.DEFAULT_SIZE, 866, Short.MAX_VALUE)
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(id_container, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(label_riwayat_usulanpangkat, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void btn_kembaliMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_kembaliMouseClicked
        ...
        String id = id_container.getText();
        ...
        try {
            ...
            if (hasil.next()) {
                ...
                form_user back = new form_user(nip);
    ...
    private void btn_unduhMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_unduhMouseClicked
        ...
        /*if (tbl_usulanpangkat.getSelectedRow() >= 0) {
            ...
            String tanggal = tabel1.getValueAt(baris, 7).toString();
        ...
        } else if (tbl_usulanpangkat_valid.getSelectedRow() >= 0) {
            int baris = tbl_usulanpangkat_valid.getSelectedRow();

            String id = tabel2.getValueAt(baris, 0).toString();
            String nip = tabel2.getValueAt(baris, 3).toString();
            String tanggal = tabel2.getValueAt(baris, 7).toString();

            try {
                Connection con = new database.connection().configDB();
                String sql = "SELECT * FROM riwayat_usulanpangkat WHERE id_riwayat_p = '" + id + "'";
                java.sql.Statement stat = con.createStatement();
                java.sql.ResultSet hasil = stat.executeQuery(sql);
                ...
                while (hasil.next()) {
                    try {
                        ...
                        String PATH = "C:/Users/" + user + "/Downloads/";
                        String directoryName = PATH.concat("" + nip + " Riwayat Berkas Usulan Pangkat (" + tanggal + ")");
                        File directory = new File(directoryName);
                        if (!directory.exists()) {
                            directory.mkdir();
                        }
                        ...
                        FileOutputStream fout1 = new FileOutputStream("C:/Users/" + user + "/Downloads/" + nip + " Riwayat Berkas Usulan Pangkat (" + tanggal + ")/IBEL_" + namafile1 + "");
                        DataOutputStream dout1 = new DataOutputStream(fout1);
                        dout1.write(bt1, 0, bt1.length);
                        fout1.close();
                        ...
                        FileOutputStream fout2 = new FileOutputStream("C:/Users/" + user + "/Downloads/" + nip + " Riwayat Berkas Usulan Pangkat (" + tanggal + ")/IJAZAH_" + namafile2 + "");
                        DataOutputStream dout2 = new DataOutputStream(fout2);
                        dout2.write(bt2, 0, bt2.length);
                        fout2.close();
                        ...
                        FileOutputStream fout3 = new FileOutputStream("C:/Users/" + user + "/Downloads/" + nip + " Riwayat Berkas Usulan Pangkat (" + tanggal + ")/KK_" + namafile3 + "");
                        DataOutputStream dout3 = new DataOutputStream(fout3);
                        dout3.write(bt3, 0, bt3.length);
                        fout3.close();
                        ...
                        FileOutputStream fout4 = new FileOutputStream("C:/Users/" + user + "/Downloads/" + nip + " Riwayat Berkas Usulan Pangkat (" + tanggal + ")/PAK_" + namafile4 + "");
                        DataOutputStream dout4 = new DataOutputStream(fout4);
                        dout4.write(bt4, 0, bt4.length);
                        fout4.close();
                        ...
                        FileOutputStream fout5 = new FileOutputStream("C:/Users/" + user + "/Downloads/" + nip + " Riwayat Berkas Usulan Pangkat (" + tanggal + ")/PANGKALAN_DATA_" + namafile5 + "");
                        DataOutputStream dout5 = new DataOutputStream(fout5);
                        dout5.write(bt5, 0, bt5.length);
                        fout5.close();
                        ...
                        FileOutputStream fout6 = new FileOutputStream("C:/Users/" + user + "/Downloads/" + nip + " Riwayat Berkas Usulan Pangkat (" + tanggal + ")/PROFESI_" + namafile6 + "");
                        DataOutputStream dout6 = new DataOutputStream(fout6);
                        dout6.write(bt6, 0, bt6.length);
                        fout6.close();
                        ...
                        FileOutputStream fout7 = new FileOutputStream("C:/Users/" + user + "/Downloads/" + nip + " Riwayat Berkas Usulan Pangkat (" + tanggal + ")/SERDIK_" + namafile7 + "");
                        DataOutputStream dout7 = new DataOutputStream(fout7);
                        dout7.write(bt7, 0, bt7.length);
                        fout7.close();
                        ...
                        FileOutputStream fout8 = new FileOutputStream("C:/Users/" + user + "/Downloads/" + nip + " Riwayat Berkas Usulan Pangkat (" + tanggal + ")/SERKOM_" + namafile8 + "");
                        DataOutputStream dout8 = new DataOutputStream(fout8);
                        dout8.write(bt8, 0, bt8.length);
                        fout8.close();
                        ...
                        FileOutputStream fout9 = new FileOutputStream("C:/Users/" + user + "/Downloads/" + nip + " Riwayat Berkas Usulan Pangkat (" + tanggal + ")/SK_CPNS_" + namafile9 + "");
                        DataOutputStream dout9 = new DataOutputStream(fout9);
                        dout9.write(bt9, 0, bt9.length);
                        fout9.close();
                        ...
                        FileOutputStream fout10 = new FileOutputStream("C:/Users/" + user + "/Downloads/" + nip + " Riwayat Berkas Usulan Pangkat (" + tanggal + ")/SK_JABATAN_" + namafile10 + "");
                        DataOutputStream dout10 = new DataOutputStream(fout10);
                        dout10.write(bt10, 0, bt10.length);
                        fout10.close();
                        ...
                        FileOutputStream fout11 = new FileOutputStream("C:/Users/" + user + "/Downloads/" + nip + " Riwayat Berkas Usulan Pangkat (" + tanggal + ")/SK_MUTASI_" + namafile11 + "");
                        DataOutputStream dout11 = new DataOutputStream(fout11);
                        dout11.write(bt11, 0, bt11.length);
                        fout11.close();
                        ...
                        FileOutputStream fout12 = new FileOutputStream("C:/Users/" + user + "/Downloads/" + nip + " Riwayat Berkas Usulan Pangkat (" + tanggal + ")/SKP_" + namafile12 + "");
                        DataOutputStream dout12 = new DataOutputStream(fout12);
                        dout12.write(bt12, 0, bt12.length);
                        fout12.close();
                        ...
                        FileOutputStream fout13 = new FileOutputStream("C:/Users/" + user + "/Downloads/" + nip + " Riwayat Berkas Usulan Pangkat (" + tanggal + ")/SK_KP_" + namafile13 + "");
                        DataOutputStream dout13 = new DataOutputStream(fout13);
                        dout13.write(bt13, 0, bt13.length);
                        fout13.close();
                        ...
                        FileOutputStream fout14 = new FileOutputStream("C:/Users/" + user + "/Downloads/" + nip + " Riwayat Berkas Usulan Pangkat (" + tanggal + ")/SK_PEMBEBASAN_" + namafile14 + "");
                        DataOutputStream dout14 = new DataOutputStream(fout14);
                        dout14.write(bt14, 0, bt14.length);
                        fout14.close();
                        ...
                        FileOutputStream fout15 = new FileOutputStream("C:/Users/" + user + "/Downloads/" + nip + " Riwayat Berkas Usulan Pangkat (" + tanggal + ")/SK_PIM_" + namafile15 + "");
                        DataOutputStream dout15 = new DataOutputStream(fout15);
                        dout15.write(bt15, 0, bt15.length);
                        fout15.close();
                        ...
                        FileOutputStream fout16 = new FileOutputStream("C:/Users/" + user + "/Downloads/" + nip + " Riwayat Berkas Usulan Pangkat (" + tanggal + ")/SK_PNS_" + namafile16 + "");
                        DataOutputStream dout16 = new DataOutputStream(fout16);
                        dout16.write(bt16, 0, bt16.length);
                        fout16.close();
                        ...
                        FileOutputStream fout17 = new FileOutputStream("C:/Users/" + user + "/Downloads/" + nip + " Riwayat Berkas Usulan Pangkat (" + tanggal + ")/SK_STLKPPI_" + namafile17 + "");
                        DataOutputStream dout17 = new DataOutputStream(fout17);
                        dout17.write(bt17, 0, bt17.length);
                        fout17.close();
                        ...
                        FileOutputStream fout18 = new FileOutputStream("C:/Users/" + user + "/Downloads/" + nip + " Riwayat Berkas Usulan Pangkat (" + tanggal + ")/SK_STLUD_" + namafile18 + "");
                        DataOutputStream dout18 = new DataOutputStream(fout18);
                        dout18.write(bt18, 0, bt18.length);
                        fout18.close();
                        ...
                        FileOutputStream fout19 = new FileOutputStream("C:/Users/" + user + "/Downloads/" + nip + " Riwayat Berkas Usulan Pangkat (" + tanggal + ")/SK_STTPL_" + namafile19 + "");
                        DataOutputStream dout19 = new DataOutputStream(fout19);
                        dout19.write(bt19, 0, bt19.length);
                        fout19.close();
                        ...
                        FileOutputStream fout20 = new FileOutputStream("C:/Users/" + user + "/Downloads/" + nip + " Riwayat Berkas Usulan Pangkat (" + tanggal + ")/SK_TUBEL_" + namafile20 + "");
                        DataOutputStream dout20 = new DataOutputStream(fout20);
                        dout20.write(bt20, 0, bt20.length);
                        fout20.close();
    ...
    private void tbl_usulanpangkatMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_usulanpangkatMouseClicked
        // TODO add your handling code here:
        //tbl_usulanpangkat_valid.getSelectionModel().clearSelection();
    }//GEN-LAST:event_tbl_usulanpangkatMouseClicked
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new form_riwayatusulan_p_user().setVisible(true);
            }
        });
    }
    ...
    private void tampil_usulanpangkat() {
        ...
        Object[] baris = {"ID", "ID", "No.", "NIP", "Nama", "Pangkat, Gol. / Ruang", "Status", "Tanggal Validasi"};
        ...
        try {
            ...
            String sql = "SELECT *, @rownum := @rownum + 1 AS number FROM usulanpangkat t\n"
                    ...
                    + "(SELECT @rownum := 0) r WHERE t.id_pegawai = '" + id + "'";
            java.sql.Statement stat = con.createStatement();
            java.sql.ResultSet hasil = stat.executeQuery(sql);
            ...
            while (hasil.next()) {
                ...
                String[] data = {id_usulan, id_pegawai, no, nip, nama, pangkat, status, tanggal};
                tabel1.addRow(data);
            ...
            JOptionPane.showMessageDialog(null, "Gagal menampilkan Riwayat Usulan Pangkat!", "Kesalahan", JOptionPane.ERROR_MESSAGE);
        }
    }

    /*private void header_usulanpangkat_valid() {
        JTableHeader tab = tbl_usulanpangkat_valid.getTableHeader();
        tab.setFont(new Font("Karla", Font.BOLD, 18));
        tab.setPreferredSize(new Dimension(128, 32));

        tbl_usulanpangkat_valid.getColumnModel().getColumn(0).setMinWidth(0);
        tbl_usulanpangkat_valid.getColumnModel().getColumn(0).setMaxWidth(0);

        tbl_usulanpangkat_valid.getColumnModel().getColumn(1).setMinWidth(0);
        tbl_usulanpangkat_valid.getColumnModel().getColumn(1).setMaxWidth(0);

        TableColumn c = tbl_usulanpangkat_valid.getColumnModel().getColumn(2);
        c.setMaxWidth(64);
        c.setMinWidth(64);
    }

    private void tampil_usulanpangkat_valid() {
        String id = id_container.getText();
        ...
        tbl_usulanpangkat_valid.setModel(tabel2);
        header_usulanpangkat_valid();

        try {
            Connection con = new database.connection().configDB();
            String sql = "SELECT *, DATE_FORMAT(tanggal_validasi, '%e %b %Y') as format_tanggal, @rownum := @rownum + 1 AS number FROM riwayat_usulanpangkat t\n"
                    + "JOIN datapegawai ON t.id_pegawai = datapegawai.id_pegawai\n"
                    + "JOIN pangkat ON t.id_pangkat = pangkat.id_pangkat,\n"
                    + "(SELECT @rownum := 0) r WHERE t.id_pegawai = '" + id + "'";
            java.sql.Statement stat = con.createStatement();
            ...
            while (hasil.next()) {
                String id_riwayat = hasil.getString("id_riwayat_p");
                String id_pegawai = hasil.getString("id_pegawai");
                String no = Integer.toString(hasil.getInt("number"));
                String nip = hasil.getString("nip");
                String nama = hasil.getString("nama");
                ...
                String[] data = {id_riwayat, id_pegawai, no, nip, nama, pangkat, status, tanggal};
                tabel2.addRow(data);
                tbl_usulanpangkat_valid.setRowHeight(30);
            }
    ...
    private javax.swing.JLabel label_riwayat_usulanpangkat;
