 ...
 * @author alessandro
 */
public class form_ubah_datapegawai extends javax.swing.JDialog {
    ...
    public form_ubah_datapegawai(java.awt.Frame parent, boolean modal, String id) {
        super(parent, modal);
        ...
        this.addWindowListener(new WindowAdapter() {
            public void windowClosing(WindowEvent we) {
                setDefaultCloseOperation(form_ubah_datapegawai.DISPOSE_ON_CLOSE);
            }
        });
    ...
    private void initComponents() {
        ...
        label_tambah_datapegawai.setText("UBAH DATA PEGAWAI");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                form_ubah_datapegawai dialog = new form_ubah_datapegawai(new javax.swing.JFrame(), true, "0");
    ...
    private void tampil_ubah(String id) {
        try {
            Connection con = new database.connection().configDB();
            String sql = "SELECT * FROM datapegawai\n"
                    ...
                    + "JOIN eselon ON datapegawai.id_eselon = eselon.id_eselon WHERE id_pegawai = '" + id + "'";
            java.sql.Statement stat = con.createStatement();
            java.sql.ResultSet hasil = stat.executeQuery(sql);
