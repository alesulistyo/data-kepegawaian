 ...
 * @author alessandro
 */
public class form_ubah_profil extends javax.swing.JDialog {

    /**
     * Creates new form form_ubah_datapegawai
     */
    private static Point point = new Point();

    public form_ubah_profil(java.awt.Frame parent, boolean modal, String nip) {
        super(parent, modal);
        ...
        this.addWindowListener(new WindowAdapter() {
            public void windowClosing(WindowEvent we) {
                setDefaultCloseOperation(form_ubah_profil.DISPOSE_ON_CLOSE);
            }
        });
    ...
    private void initComponents() {
        ...
        label_tambah_datapegawai.setText("UBAH PROFIL SAYA");
        ...
        id_container.setFont(new java.awt.Font("Karla", 0, 14)); // NOI18N
        ...
        datechooser_tanggalnaikpangkat.setEnabled(false);
        datechooser_tanggalnaikpangkat.setFont(new java.awt.Font("Karla", 0, 18)); // NOI18N

        datechooser_tanggalnaikjabatan.setEnabled(false);
            ...
            .addGroup(panel_bg_tambah_datapegawaiLayout.createSequentialGroup()
                .addGroup(panel_bg_tambah_datapegawaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(panel_bg_tambah_datapegawaiLayout.createSequentialGroup()
                        ...
                        .addGroup(panel_bg_tambah_datapegawaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(panel_bg_tambah_datapegawaiLayout.createSequentialGroup()
                                .addGroup(panel_bg_tambah_datapegawaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(label_nip, javax.swing.GroupLayout.PREFERRED_SIZE, 256, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(label_tempatlahir, javax.swing.GroupLayout.PREFERRED_SIZE, 256, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(label_tanggallahir, javax.swing.GroupLayout.PREFERRED_SIZE, 256, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                ...
                                .addGroup(panel_bg_tambah_datapegawaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(label_agama, javax.swing.GroupLayout.PREFERRED_SIZE, 256, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(panel_bg_tambah_datapegawaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(cbb_statuskawin, javax.swing.GroupLayout.PREFERRED_SIZE, 320, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(cbb_agama, javax.swing.GroupLayout.PREFERRED_SIZE, 320, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(cbb_jeniskelamin, javax.swing.GroupLayout.PREFERRED_SIZE, 320, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(panel_bg_tambah_datapegawaiLayout.createSequentialGroup()
                ...
                .addGroup(panel_bg_tambah_datapegawaiLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panel_bg_tambah_datapegawaiLayout.createSequentialGroup()
                        .addComponent(btn_simpan, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(32, 32, 32))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panel_bg_tambah_datapegawaiLayout.createSequentialGroup()
                        .addComponent(id_container, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())))
        );
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(panel_bg_tambah_datapegawai, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                form_ubah_profil dialog = new form_ubah_profil(new javax.swing.JFrame(), true, "0");
    ...
    private void tampil_ubah(String nip) {
        try {
            Connection con = new database.connection().configDB();
            String sql = "SELECT * FROM datapegawai\n"
                    ...
                    + "JOIN eselon ON datapegawai.id_eselon = eselon.id_eselon WHERE nip = '" + nip + "'";
            java.sql.Statement stat = con.createStatement();
            java.sql.ResultSet hasil = stat.executeQuery(sql);

            if (hasil.next()) {
                id_container.setText(hasil.getString("id_pegawai"));
                fld_nip.setText(hasil.getString("nip"));
                fld_nama.setText(hasil.getString("nama"));
                fld_tempatlahir.setText(hasil.getString("tempat_lahir"));
                datechooser_tanggallahir.setDate(hasil.getDate("tanggal_lahir"));
                cbb_pangkat.setSelectedIndex(hasil.getInt("id_pangkat"));
                cbb_jabatan.setSelectedIndex(hasil.getInt("id_jabatan"));
                cbb_eselon.setSelectedIndex(hasil.getInt("id_eselon"));
                cbb_jeniskelamin.setSelectedIndex(hasil.getInt("index_jenis_kelamin"));
                cbb_agama.setSelectedIndex(hasil.getInt("index_agama"));
                cbb_statuskawin.setSelectedIndex(hasil.getInt("index_status_kawin"));
                fld_alamat.setText(hasil.getString("alamat"));
                datechooser_tanggalnaikpangkat.setDate(hasil.getDate("tgl_naikpangkat"));
                datechooser_tanggalnaikjabatan.setDate(hasil.getDate("tgl_naikjabatan"));
            } else {
    ...
    private void simpan() {
        ...
        if (empty(getnip) || empty(getnama) || empty(gettempatlahir) || datechooser_tanggallahir.getDate() == null || getindexpangkat == 0 || getindexjabatan == 0 || getindexeselon == 0 || getindexjeniskelamin == 0 || getindexagama == 0 || getindexstatuskawin == 0 || empty(getalamat) || datechooser_tanggalnaikpangkat.getDate() == null || datechooser_tanggalnaikjabatan.getDate() == null) {
            ...
            try {
                Connection con = new database.connection().configDB();
                String get = "SELECT * FROM datapegawai WHERE nip = '" + getnip + "' AND id_pegawai != '" + id_container.getText() + "'";
                java.sql.Statement stat = con.createStatement();
                java.sql.ResultSet hasil = stat.executeQuery(get);

                if (hasil.next()) {
                    JOptionPane.showMessageDialog(null, "Data pegawai dengan NIP yang sama sudah terdaftar", "Informasi", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    try {
                        String sql = "UPDATE datapegawai SET id_pangkat = ?, id_jabatan = ?, id_eselon = ?, nip = ?, nama = ?, tempat_lahir = ?, tanggal_lahir = ?, index_jenis_kelamin = ?, jenis_kelamin = ?, index_agama = ?, agama = ?, index_status_kawin = ?, status_kawin = ?, alamat = ?, tgl_naikpangkat = ?, tgl_naikjabatan = ? WHERE id_pegawai = '" + id_container.getText() + "'";
                        java.sql.PreparedStatement prestat = (PreparedStatement) con.prepareStatement(sql);
                        prestat.setInt(1, getindexpangkat);
                        prestat.setInt(2, getindexjabatan);
                        prestat.setInt(3, getindexeselon);
                        prestat.setString(4, getnip);
                        prestat.setString(5, getnama);
                        prestat.setString(6, gettempatlahir);
                        prestat.setString(7, gettanggallahir);
                        prestat.setInt(8, getindexjeniskelamin);
                        prestat.setString(9, getjeniskelamin);
                        prestat.setInt(10, getindexagama);
                        prestat.setString(11, getagama);
                        prestat.setInt(12, getindexstatuskawin);
                        prestat.setString(13, getstatuskawin);
                        prestat.setString(14, getalamat);
                        prestat.setString(15, gettanggalnaik_p);
                        prestat.setString(16, gettanggalnaik_j);
                        prestat.executeUpdate();
                        prestat.close();

                        JOptionPane.showMessageDialog(null, "Data Pegawai berhasil diubah!", "Informasi", JOptionPane.INFORMATION_MESSAGE);
                        this.setVisible(false);

                    } catch (Exception e) {
                        JOptionPane.showMessageDialog(null, "Gagal mengubah Data Pegawai!", "Kesalahan", JOptionPane.ERROR_MESSAGE);
                    } finally {
                        hasil.close();
                        stat.close();
                        con.close();
