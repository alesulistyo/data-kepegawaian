 ...
 * @author alessandro
 */
public class form_riwayatusulan_j_user extends javax.swing.JFrame {

    /**
     * Creates new form form_riwayat_usulanjabatan
     */
    ...
    public form_riwayatusulan_j_user(String id) {
        ...
        this.addWindowListener(new WindowAdapter() {
            public void windowClosing(WindowEvent we) {
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    setDefaultCloseOperation(form_riwayatusulan_j_user.DISPOSE_ON_CLOSE);
                } else if (confirm == JOptionPane.NO_OPTION) {
                    setDefaultCloseOperation(form_riwayatusulan_j_user.DO_NOTHING_ON_CLOSE);
                }
            }
        });
        ...
        //tampil_usulanjabatan_valid();

    }

    private form_riwayatusulan_j_user() {
    ...
    private void initComponents() {
        ...
        tbl_usulanjabatan.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbl_usulanjabatanMouseClicked(evt);
            }
        });
    ...
    private void btn_unduhMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_unduhMouseClicked
        ...
        /*if (tbl_usulanjabatan.getSelectedRow() >= 0) {
        ...
        } else if (tbl_usulanjabatan_valid.getSelectedRow() >= 0) {
            int baris = tbl_usulanjabatan_valid.getSelectedRow();
    ...
    private void tbl_usulanjabatanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_usulanjabatanMouseClicked
        // TODO add your handling code here:
        //tbl_usulanjabatan_valid.getSelectionModel().clearSelection();
    }//GEN-LAST:event_tbl_usulanjabatanMouseClicked
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new form_riwayatusulan_j_user().setVisible(true);
            }
        });
    }
    ...
    private void tampil_usulanjabatan() {
        ...
        try {
            ...
            while (hasil.next()) {
                ...
                String[] data = {id_usulan, id_pegawai, no, nip, nama, jabatan, eselon, status, tanggal};
                tabel1.addRow(data);
    ...
    /* private void header_usulanjabatan_valid() {
        JTableHeader tab = tbl_usulanjabatan_valid.getTableHeader();
        tab.setFont(new Font("Karla", Font.BOLD, 18));
        tab.setPreferredSize(new Dimension(128, 32));

        tbl_usulanjabatan_valid.getColumnModel().getColumn(0).setMinWidth(0);
        tbl_usulanjabatan_valid.getColumnModel().getColumn(0).setMaxWidth(0);

        tbl_usulanjabatan_valid.getColumnModel().getColumn(1).setMinWidth(0);
        tbl_usulanjabatan_valid.getColumnModel().getColumn(1).setMaxWidth(0);

        TableColumn c = tbl_usulanjabatan_valid.getColumnModel().getColumn(2);
        c.setMaxWidth(64);
        c.setMinWidth(64);
    }

    private void tampil_usulanjabatan_valid() {
        String id = id_container.getText();
        ...
        tbl_usulanjabatan_valid.setModel(tabel2);
        header_usulanjabatan_valid();
        ...
        try {
            ...
            while (hasil.next()) {
                ...
                tabel2.addRow(data);
                tbl_usulanjabatan_valid.setRowHeight(30);
            }
